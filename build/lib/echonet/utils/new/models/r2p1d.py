"""
Source of Building blocks : http://pytorch.org/vision/main/_modules/torchvision/models/video/resnet.html#r2plus1d_18
Adapted from : https://arxiv.org/abs/1711.11248
"""
...
class VideoResNet_unc(nn.Module):
    def __init__(
        self,
        ...
        """
        super(VideoResNet_unc, self).__init__()
        self.inplanes = 64
        ...
        print("using drop_rate = ", drop_rate)
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        x = x.flatten(1)
        x_feat_1 = nn.functional.dropout(x, p=self.drop_rate, training=True)
        x_feat_2 = nn.functional.dropout(x, p=self.drop_rate, training=True)

        #Output 1
        x_1 = self.fc_1(x_feat_1)
        #Output 2
        x_2 = self.fc_2(x_feat_2)
...
def _video_resnet_unc(arch: str, pretrained: bool = False, progress: bool = True, **kwargs: Any) -> VideoResNet_unc:
    model = VideoResNet_unc(**kwargs)
...
def r2plus1d_18_unc(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> VideoResNet_unc:
    """
    TODO: Testing r2plus1d_18_unc
    """
    return _video_resnet_unc(
        "r2plus1d_18",
        pretrained,
        progress,
        block=BasicBlock,
